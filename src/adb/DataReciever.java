...
public class DataReciever 
{
     ...
     * @param boolean log нужно ли логировать результат выполнения
     * @return ArrayList<String> список устройств
     */
    public ArrayList<String> getDevices(boolean log)
    {
        ...
        finally
        {
            ...
            catch(IOException e) { logAndStackTrace(null, e); }
    ...
    public void deleteFile(String path)
    {
        ...
        catch (InterruptedException e) { logAndStackTrace(null, e); }
        finally
        {
            try
            {
    ...
    public static ModelPackage getPackages() throws IOException, InterruptedException
    {
        ...
        for (int i = 0; i < packages.length; i++)           
            mp.setRow(new TableRowElementPackage(packages[i]) );
